...
public class ModBlocks {
	...
	private static Block registerBlock(String name, Block block) {
		...
		return Registry.register(Registry.BLOCK, new Identifier(FabricatedExchange.MOD_ID, name), block);
	}

	private static Item registerBlockItem(String name, Block block) {
		Item item = Registry.register(Registry.ITEM, new Identifier(FabricatedExchange.MOD_ID, name),
				new BlockItem(block, new FabricItemSettings().group(ModItemGroups.FABRICATED_EXCHANGE)));
		return item;
	}
