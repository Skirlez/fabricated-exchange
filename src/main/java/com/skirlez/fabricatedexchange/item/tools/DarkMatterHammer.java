...
public class DarkMatterHammer extends PickaxeItem implements ChargeableItem, OutliningItem, ItemWithModes {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        if (charge == 0) {
            tooltip.add(Text.translatable("item.fabricated-exchange.mode_switch")
                    .append(" ")
                    .append(Text.translatable("item.fabricated-exchange.dark_matter_hammer.uncharged")
