...
public class DiviningRod extends Item {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        Vec3d vec = context.getPlayer().getRotationVec(1.0F);
        Direction direction = Direction.getFacing(vec.x, vec.y, vec.z);
    ...
    public void calcEmcInDirection(int dyStart, int dyEnd, int dxStart, int dxEnd, int dzStart, int dzEnd, ItemUsageContext context, Direction direction){
        ...
        if (maxPos != null) {
            ...
            if (player != null) {
                Text message = Text.translatable("Divining Rod Found: " + maxEmc);
